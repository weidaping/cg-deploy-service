...
$(function () {
    $("#jqGrid").jqGrid({
        url: baseURL + 'SubscribeTrans/getSplitList',
        datatype: "json",
        colModel: [
            ...
            {label: 'profitAmount', name: 'profitAmount', sortable: false},
            {label: 'commissionAmount', name: 'commissionAmount', sortable: false},
            {label: 'stzfAmount', name: 'stzfAmount', sortable: false},
            {label: 'independentProfitAmount', name: 'independentProfitAmount', sortable: false},
